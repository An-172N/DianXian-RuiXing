...
asset_path = os.path.join(get_asset_path(), 'ASSET')
win = pyg.Rect((120, 15,
                345, 330))
eff = pyg.Rect((105, 0,
                375, 360))
...
bg = pyg.image.load(os.path.join(asset_path, 'IMG_GAMEBG.png')).convert_alpha()
...
level = 0
pic_list = [
    (1, os.path.join(asset_path, 'IMG_STAGE1BG.png')),
    (2, os.path.join(asset_path, 'IMG_STAGE2BG.png')),
    (3, os.path.join(asset_path, 'IMG_STAGE3BG.png'))
]

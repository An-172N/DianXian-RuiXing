...
def save_file() -> None:
    name = LOGIC.Tool.replace_illegal_char(GLOBAL.name)
    date_time = LOGIC.Tool.get_datetime()
...
def single_bomb() -> None:
    GLOBAL.is_s_divide, GLOBAL.power = LOGIC.Plane.single_bomb(GLOBAL.is_s_divide, GLOBAL.power, 12)

...
class Qdi(pygame.sprite.Sprite):
    ...
    char_image = pygame.image.load(os.path.join(asset_path, 'IMAGE\IMG_QDI.png')).convert_alpha()
    ...
    def free(th) -> None:
        ...
        if th.bullet_counter < 1:
            for _ in range(48):
                ...
                sprite = SPRITE.Barrage(2, 4, th.color, current_angle, sprite_pos)
                sprite.update()
    ...
    def fire(th) -> None:
        ...
        if th.bullet_counter < 6 and th.bullet_timer % 2 == 0:
            ...
            sprite = SPRITE.Barrage(2, 3.5, th.color, current_angle, sprite_pos)
            sprite.update()

        ...
        if th.bullet_timer % 1 == 0 and th.bullet_counter < 18:
            for bullet_info in bullet_type:
                ...
                for j in range(45, 136, 90):
                    ...
                    sprite = barrage(PRELOAD.effective, 0, 4, th.color, current_angle, sprite_pos)
                    sprite.update()
        ...
        if th.bullet_counter < 1:
            for _ in range(6):
                for j, k in itertools.product((150, 185, 220, 255, 292, 327, 365, 400, 435), range(1, 4)):
                    ...
                    sprite = barrage(PRELOAD.effective, 0, speed, th.color, current_angle, sprite_pos)
    ...
    def fire(th) -> None:
        ...
        if th.bullet_timer % 6 == 0 and th.bullet_counter < 3:
            ...
            for i in range(-30, 31, 30):
                ...
                sprite = barrage(PRELOAD.effective, 0, 4, th.color, current_angle, pos)
                sprite.update()
        ...
        if th.timer % 110 >= 91:
            ...
            if th.timer % 91 == 0:
                for i in range(0, 360, 120 if th.choice == th.fire else 90):
                    ...
                    particle = barrage(PRELOAD.effective, 0, 4, PRELOAD.color_dict[6], current_angle, pos, False)

...
class BaseShape(pyg.sprite.Sprite):
    ...
    def polygon(th):
        ...
        pyg.draw.polygon(surface, th.clr, polygon_pts, th.bd)
    ...
    def square(th):
        ...
        pyg.draw.rect(surface, th.clr, surface.get_rect(), th.bd)
    ...
    def circle(th):
        ...
        pyg.draw.circle(surface, th.clr, (center_x, center_y), radius, th.bd)

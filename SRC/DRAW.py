...
class ShapeDraw:
    ...
    def polygon(self):
        surface = pyg.Surface((self.width, self.height), pyg.SRCALPHA)
        ...
        pyg.draw.polygon(surface, self.color, [point1, point2, point3], self.border)
    ...
    def rect(self):
        ...
        pyg.draw.rect(surface, self.color, surface.get_rect(), self.border)
    ...
    def circle(self):
        ...
        pyg.draw.circle(surface, self.color, (center_x, center_y), radius, self.border)

...
class Event:
    ...
    def chk_keydown_evt(th, evt):
        key_dict_game = {
            ...
            pyg.K_LEFT: lambda: setattr(th.own.pln_mgr, "mv_left",
                                        True),
            pyg.K_LSHIFT: lambda: th.own.pln_mgr.set_pln_spd(1),
        ...
        key_dict_talk = {
            pyg.K_z: lambda: setattr(th.own.stg_mgr, "talk_txt",
                                     th.own.stg_mgr.talk_txt + 1),
        ...
        key_dict_ru_sure = {
            pyg.K_y: lambda: th.own.rst_mgr.rst_game(),
        ...
        key_dict_over = {
            pyg.K_RETURN: lambda: th.own.sav_mgr.exit(),
    ...
    def chk_keyup_evt(th, evt):
        key_dict = {
            ...
            pyg.K_LEFT: lambda: setattr(th.own.pln_mgr, "mv_left",
                                        False),
            pyg.K_LSHIFT: lambda: th.own.pln_mgr.set_pln_spd(0),
            pyg.K_z: lambda: setattr(th.own.blt_mgr, "is_cnt_fusil",
                                     False)
        }

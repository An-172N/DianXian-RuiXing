        ...
        "down": {
            "game": {
                ...
                pyg.K_LSHIFT: lambda th: th.proc("sw", "pln", "is_slow",
                                                 True),
                pyg.K_z: lambda th: th.proc("sw", "pln", "is_fusil",
                                            True),
            ...
            "over": {
                pyg.K_RETURN: lambda th: (th.proc("func", "sav", "sav")(),
                                          th.rst_game()),
                pyg.K_ESCAPE: lambda th: th.rst_game(),
                pyg.K_BACKSPACE: lambda th: th.proc("add", "sav", "name2",
                                                    -1)
            }
        },
        "up": {
                ...
                if not th.proc('get', 'main', 'run'):
                    ...
                    if th.proc('get', 'main', 'sav'):
                        if evt.key in th.key_dict["down"]["over"]:
                            ...
                            th.proc("add", "sav", "name1", evt.unicode)
